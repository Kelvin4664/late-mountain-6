"""
Django settings for late_mountain_6 project.
...
ROOT_URLCONF = 'late_mountain_6.urls'
...
WSGI_APPLICATION = 'late_mountain_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_mountain_6 API",
    "DESCRIPTION": "API documentation for late_mountain_6 App",
    "VERSION": "v1",
}
